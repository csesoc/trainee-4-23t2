export default function PracticeQuestion() {
    return (
        <div id="question-container" className="m-4 bg-theme-black px-4 py-2" style={{minHeight: "50vh", maxHeight: "85vh", display:"flex", width: "100%", flexDirection: "row", padding: "20px", fontSize: "20px", overflow: "hidden", borderRadius: "30px", boxSizing: "border-box", flexWrap: "wrap"}}>
            <div style={{width:"35%", borderRight: "1px solid rgba(100,92,167,1)", textAlign: "center", display: "flex", padding: "10px", flexDirection: "column"}}>
                <h1 style={{marginBottom: "8vh"}}>Question</h1>
            ...
            <div style={{width:"65%", borderLeft: "1px solid rgba(100,92,167,1)", display: "flex", alignItems: "center", padding: "10px", flexDirection: "column",  overflowWrap: "anywhere"}}>
                <h2 style={{marginBottom: "8vh"}}>Answer</h2>
